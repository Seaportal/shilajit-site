...
const ResinPage = () => {
  ...
  const [products, setProducts] = useState([
    {
      ...
      url: 'https://www.amazon.com/Authentic-Shilajit-Organic-Minerals-Himalayas/dp/B0DJC5GZT2',
      image: '/src/assets/products/resin-1.jpg'
    },
    {
      id: 2,
      ...
      image: '/src/assets/products/resin-2.jpg'
    },
    {
      id: 3,
      ...
      image: '/src/assets/products/resin-3.jpg'
    },
    {
      id: 4,
      ...
      image: '/src/assets/products/resin-4.jpg'
    },
    {
      id: 5,
      ...
      image: '/src/assets/products/resin-5.jpg'
    },
    {
      id: 6,
      ...
      image: '/src/assets/products/resin-6.jpg'
    }
  ]);
  ...
  const getPriceCategoryStyle = (category) => {
    switch (category) {
      case 'high':
        return { color: '#dc2626', label: 'Overpriced' }; // красный
      case 'optimal':
        return { color: '#16a34a', label: 'Best Value' }; // зеленый
      case 'budget':
        return { color: '#dc2626', label: 'Budget' }; // красный
      default:
        return { color: '#6b7280', label: 'Not specified' }; // серый
    }
  };
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center space-x-4 mb-4">
                        <AdminRating 
                          ...
                          totalRatings={product.id === 1 ? 847 : product.id === 2 ? 234 : product.id === 3 ? 156 : product.id === 4 ? 89 : product.id === 5 ? 67 : 43}
                          size="lg"
                          editable={true}
